...
const tracks = [
  {
    id: 1,
    url: require('./src/assests/songs/FJULaFOI.mp3'),
    title: 'La FOI',
    artist: 'FJU LYON',
  ...
  {
    id: 2,
    url: require('./src/assests/songs/FJUTConnaisPasLa.mp3'),
  ...
  {
    id: 3,
    url: require('./src/assests/songs/FJU-Reviensàlamaison.mp3'),
  ...
  {
    id: 4,
    url: require('./src/assests/songs/FJU-Parfum.mp3'),
    title: 'Parfum',
    artist: 'FJU LYON',
  ...
  {
    id: 5,
    url: require('./src/assests/songs/FJU-Lumière.mp3'),
    title: 'Lumière',
    artist: 'FJU LYON',
